        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Machine Maintenance Information</h3>
            </div>
            <div class="card-body">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select :class="['form-control', {'is-invalid': errorFor('machine_id')}]"
...
export default {
  ...
  created() {
    ...
    if (this.$route.name === 'machines_maintenances_edit') {
      this.axios.get('/machines_maintenances/'+this.$route.params.id)
        .then((response) => {
      ...
      this.title = 'Edit Machine Maintenance';
    }
  },
  mounted() {
    let self = this;
  ...
  methods: {
    submit() {
      ...
      if (this.$route.name === 'machines_maintenances_edit') {
        this.axios.patch('/machines_maintenances/'+this.$route.params.id, this.form)
          .then(() => {
            this.$router.push({name: 'machines_maintenances'});
        ...
        this.axios.post('/machines_maintenances', this.form)
          .then(() => {
            this.$router.push({name: 'machines_maintenances'});
